...
// exam date, off after — using a guessed Oct 6 exam date if the user hasn't
// set a real one.
...
/** The next Oct 6 on or after `today` (this year's, or next year's if it already passed).
    Compares calendar dates, not full timestamps — `today`'s time-of-day must
    not push it past Oct 6 on Oct 6 itself. */
